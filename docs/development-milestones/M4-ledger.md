...
- Decision: 负责人不是全局账本角色；负责人可以查看自己负责俱乐部作为 `issuing_club_id` 发出的积分流水，以及该负责俱乐部成员在本俱乐部来源下汇总出的积分摘要；M4.7 的成员摘要只按该负责俱乐部发放来源聚合，不是员工全量积分账户。这里的“他人/其他”指其他俱乐部、无俱乐部来源或全局来源，不包括自己负责俱乐部分发给成员的积分。负责人不得查看同一员工在这些来源下的积分流水、原因、材料或来源快照。
...
- [x] 员工查询本人积分明细。
- [x] 员工查询本人余额。
- [x] 负责人查询负责俱乐部发放来源下的成员积分摘要，且该摘要不是员工全量积分账户。
