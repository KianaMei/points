...
- 2026-06-25：M2.6 质量验证：`git diff --check` 无空白错误；`rg -n "tenant_id|TenantBaseDO" yudao-module-clubpoints` 无命中；`rg -n "Co-authored|co-author|AI-generated|Generated by AI|ChatGPT" yudao-module-clubpoints` 无命中。
