 ...
 * 主要复用了 MyBatis Plus 的 DataPermission interceptor tests 的单元测试
...
public class DataPermissionRuleHandlerTest extends BaseMockitoUnitTest {
    ...
    public void setUp() {
        ...
        // 组织的数据权限规则
        DataPermissionRule orgRule = new DataPermissionRule() {

            private static final String COLUMN = "org_id";
        ...
        // 设置到上下文
        when(ruleFactory.getDataPermissionRule(any())).thenReturn(Arrays.asList(orgRule, deptRule));
    }

    @Test
    void delete() {
        assertSql("delete from entity where id = ?",
                "DELETE FROM entity WHERE id = ? AND entity.org_id = 1");
    }

    @Test
    void update() {
        assertSql("update entity set name = ? where id = ?",
                "UPDATE entity SET name = ? WHERE id = ? AND entity.org_id = 1");
    }
    ...
    void selectSingle() {
        ...
        assertSql("select * from entity where id = ?",
                "SELECT * FROM entity WHERE id = ? AND entity.org_id = 1");

        assertSql("select * from entity where id = ? or name = ?",
                "SELECT * FROM entity WHERE (id = ? OR name = ?) AND entity.org_id = 1");
        ...
        assertSql("SELECT * FROM entity WHERE not (id = ? OR name = ?)",
                "SELECT * FROM entity WHERE NOT (id = ? OR name = ?) AND entity.org_id = 1");
    }
    ...
    void selectSubSelectIn() {
        ...
        assertSql("SELECT * FROM entity e WHERE e.id IN (select e1.id from entity1 e1 where e1.id = ?)",
                "SELECT * FROM entity e WHERE e.id IN (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.org_id = 1");
        // 在最前
        assertSql("SELECT * FROM entity e WHERE e.id IN " +
                ...
                "SELECT * FROM entity e WHERE e.id IN " +
                        "(SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.id = ? AND e.org_id = 1");
        // 在最后
        assertSql("SELECT * FROM entity e WHERE e.id = ? and e.id IN " +
                ...
                "SELECT * FROM entity e WHERE e.id = ? AND e.id IN " +
                        "(SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.org_id = 1");
        // 在中间
        assertSql("SELECT * FROM entity e WHERE e.id = ? and e.id IN " +
                        "(select e1.id from entity1 e1 where e1.id = ?) and e.id = ?",
                "SELECT * FROM entity e WHERE e.id = ? AND e.id IN " +
    ...
    void selectSubSelectEq() {
        ...
        assertSql("SELECT * FROM entity e WHERE e.id = (select e1.id from entity1 e1 where e1.id = ?)",
                "SELECT * FROM entity e WHERE e.id = (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.org_id = 1");
    }
    ...
    void selectSubSelectInnerNotEq() {
        ...
        assertSql("SELECT * FROM entity e WHERE not (e.id = (select e1.id from entity1 e1 where e1.id = ?))",
                "SELECT * FROM entity e WHERE NOT (e.id = (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1)) AND e.org_id = 1");

        assertSql("SELECT * FROM entity e WHERE not (e.id = (select e1.id from entity1 e1 where e1.id = ?) and e.id = ?)",
                "SELECT * FROM entity e WHERE NOT (e.id = (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.id = ?) AND e.org_id = 1");
    }
    ...
    void selectSubSelectExists() {
        ...
        assertSql("SELECT * FROM entity e WHERE EXISTS (select e1.id from entity1 e1 where e1.id = ?)",
                "SELECT * FROM entity e WHERE EXISTS (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.org_id = 1");


        /* NOT EXISTS */
        assertSql("SELECT * FROM entity e WHERE NOT EXISTS (select e1.id from entity1 e1 where e1.id = ?)",
                "SELECT * FROM entity e WHERE NOT EXISTS (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.org_id = 1");
    }
    ...
    void selectFromSelect() {
        assertSql("SELECT * FROM (select e.id from entity e WHERE e.id = (select e1.id from entity1 e1 where e1.id = ?))",
                "SELECT * FROM (SELECT e.id FROM entity e WHERE e.id = (SELECT e1.id FROM entity1 e1 WHERE e1.id = ? AND e1.org_id = 1) AND e.org_id = 1)");
    }

    @Test
    void selectBodySubSelect() {
        assertSql("select t1.col1,(select t2.col2 from t2 t2 where t1.col1=t2.col1) from t1 t1",
                "SELECT t1.col1, (SELECT t2.col2 FROM t2 t2 WHERE t1.col1 = t2.col1 AND t2.org_id = 1) FROM t1 t1 WHERE t1.org_id = 1");
    }
    ...
    void selectLeftJoin() {
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "LEFT JOIN entity1 e1 ON e1.id = e.id AND e1.org_id = 1 " +
                        "WHERE (e.id = ? OR e.name = ?) AND e.org_id = 1");
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "LEFT JOIN entity1 e1 ON e1.id = e.id AND e1.org_id = 1 " +
                        "LEFT JOIN entity2 e2 ON e1.id = e2.id AND e2.org_id = 1 " +
                        "WHERE e.org_id = 1");
    }
    ...
    void selectRightJoin() {
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "RIGHT JOIN entity1 e1 ON e1.id = e.id AND e.org_id = 1 " +
                        "WHERE e1.org_id = 1");
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "RIGHT JOIN entity1 e1 ON e1.id = e.id AND e.org_id = 1 " +
                        "WHERE (e.id = ? OR e.name = ?) AND e1.org_id = 1");
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "RIGHT JOIN entity1 e1 ON e1.id = e.id AND e.org_id = 1 " +
                        "RIGHT JOIN entity2 e2 ON e1.id = e2.id AND e1.org_id = 1 " +
                        "WHERE e2.org_id = 1");
    }
    ...
    void selectMixJoin() {
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "LEFT JOIN entity1 e1 ON e1.id = e.id AND e1.org_id = 1 " +
                        "RIGHT JOIN entity2 e2 ON e1.id = e2.id AND e.org_id = 1 " +
                        "WHERE e2.org_id = 1");
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "LEFT JOIN entity1 e1 ON e1.id = e.id AND e1.org_id = 1 " +
                        "INNER JOIN entity2 e2 ON e1.id = e2.id AND e.org_id = 1 AND e2.org_id = 1");
    }
    ...
    void selectJoinSubSelect() {
        assertSql("select * from (select * from entity) e1 " +
                        "left join entity2 e2 on e1.id = e2.id",
                "SELECT * FROM (SELECT * FROM entity WHERE entity.org_id = 1) e1 " +
                        "LEFT JOIN entity2 e2 ON e1.id = e2.id AND e2.org_id = 1");
        ...
        assertSql("select * from entity1 e1 " +
                ...
                "SELECT * FROM entity1 e1 " +
                        "LEFT JOIN (SELECT * FROM entity2 WHERE entity2.org_id = 1) e2 " +
                        "ON e1.id = e2.id " +
                        "WHERE e1.org_id = 1");
    }
    ...
    void selectSubJoin() {
        ...
        assertSql("select * FROM " +
                ...
                "SELECT * FROM " +
                        "(entity1 e1 RIGHT JOIN entity2 e2 ON e1.id = e2.id AND e1.org_id = 1) " +
                        "WHERE e2.org_id = 1");

        assertSql("select * FROM " +
                        "(entity1 e1 LEFT JOIN entity2 e2 ON e1.id = e2.id)",
                "SELECT * FROM " +
                        "(entity1 e1 LEFT JOIN entity2 e2 ON e1.id = e2.id AND e2.org_id = 1) " +
                        "WHERE e1.org_id = 1");
        ...
        assertSql("select * FROM " +
                ...
                "SELECT * FROM " +
                        "(entity1 e1 LEFT JOIN entity2 e2 ON e1.id = e2.id AND e2.org_id = 1) " +
                        "RIGHT JOIN entity3 e3 ON e1.id = e3.id AND e1.org_id = 1 " +
                        "WHERE e3.org_id = 1");
        ...
        assertSql("select * FROM entity e " +
                        ...
                        "on e.id = e2.id",
                "SELECT * FROM entity e " +
                        "LEFT JOIN (entity1 e1 RIGHT JOIN entity2 e2 ON e1.id = e2.id AND e1.org_id = 1) " +
                        "ON e.id = e2.id AND e2.org_id = 1 " +
                        "WHERE e.org_id = 1");
        ...
        assertSql("select * FROM entity e " +
                        ...
                        "on e.id = e2.id",
                "SELECT * FROM entity e " +
                        "LEFT JOIN (entity1 e1 LEFT JOIN entity2 e2 ON e1.id = e2.id AND e2.org_id = 1) " +
                        "ON e.id = e2.id AND e1.org_id = 1 " +
                        "WHERE e.org_id = 1");
        ...
        assertSql("select * FROM entity e " +
                        ...
                        "on e.id = e2.id",
                "SELECT * FROM entity e " +
                        "RIGHT JOIN (entity1 e1 LEFT JOIN entity2 e2 ON e1.id = e2.id AND e2.org_id = 1) " +
                        "ON e.id = e2.id AND e.org_id = 1 " +
                        "WHERE e1.org_id = 1");
    }
    ...
    void selectLeftJoinMultipleTrailingOn() {
        ...
        assertSql("SELECT * FROM entity e " +
                ...
                "SELECT * FROM entity e " +
                        "LEFT JOIN entity1 e1 " +
                        "LEFT JOIN entity2 e2 ON e2.id = e1.id AND e2.org_id = 1 " +
                        "ON e1.id = e.id AND e1.org_id = 1 " +
                        "WHERE (e.id = ? OR e.NAME = ?) AND e.org_id = 1");
    ...
    void selectInnerJoin() {
        ...
        assertSql("SELECT * FROM entity e " +
                        ...
                        "WHERE e.id = ? OR e.name = ?",
                "SELECT * FROM entity e " +
                        "INNER JOIN entity1 e1 ON e1.id = e.id AND e.org_id = 1 AND e1.org_id = 1 " +
                        "WHERE e.id = ? OR e.name = ?");
        ...
        assertSql("SELECT * FROM entity,entity1 " +
                ...
                "SELECT * FROM entity, entity1 " +
                        "WHERE entity.id = entity1.id AND entity.org_id = 1 AND entity1.org_id = 1");

        // 隐式内连接
        assertSql("SELECT * FROM entity a, with_as_entity1 b " +
                        "WHERE a.id = b.id",
                "SELECT * FROM entity a, with_as_entity1 b " +
                        "WHERE a.id = b.id AND a.org_id = 1");
        ...
        assertSql("SELECT * FROM (entity,entity1) " +
                ...
                "SELECT * FROM (entity, entity1) " +
                        "WHERE entity.id = entity1.id " +
                        "AND entity.org_id = 1 AND entity1.org_id = 1");
        ...
        assertSql("SELECT * FROM ((entity,entity1),entity2) " +
                ...
                "SELECT * FROM ((entity, entity1), entity2) " +
                        "WHERE entity.id = entity1.id AND entity.id = entity2.id " +
                        "AND entity.org_id = 1 AND entity1.org_id = 1 AND entity2.org_id = 1");
    ...
    void selectWithAs() {
        assertSql("with with_as_A as (select * from entity) select * from with_as_A",
                "WITH with_as_A AS (SELECT * FROM entity WHERE entity.org_id = 1) SELECT * FROM with_as_A");
    }
    ...
    void selectIgnoreTable() {
        assertSql(" SELECT dict.dict_code, item.item_text AS \"text\", item.item_value AS \"value\" FROM sys_dict_item item INNER JOIN sys_dict dict ON dict.id = item.dict_id WHERE dict.dict_code IN (1, 2, 3) AND item.item_value IN (1, 2, 3)",
                "SELECT dict.dict_code, item.item_text AS \"text\", item.item_value AS \"value\" FROM sys_dict_item item INNER JOIN sys_dict dict ON dict.id = item.dict_id AND item.org_id = 1 WHERE dict.dict_code IN (1, 2, 3) AND item.item_value IN (1, 2, 3)");
    }
    ...
    public void testSelectSingle() {
        ...
        assertSql("select * from t_user where id = ?",
                "SELECT * FROM t_user WHERE id = ? AND t_user.org_id = 1 AND t_user.dept_id IN (10, 20)");

        assertSql("select * from t_user where id = ? or name = ?",
                "SELECT * FROM t_user WHERE (id = ? OR name = ?) AND t_user.org_id = 1 AND t_user.dept_id IN (10, 20)");
        ...
        assertSql("SELECT * FROM t_user WHERE not (id = ? OR name = ?)",
                "SELECT * FROM t_user WHERE NOT (id = ? OR name = ?) AND t_user.org_id = 1 AND t_user.dept_id IN (10, 20)");
    }
    ...
    public void testSelectLeftJoin() {
        ...
        assertSql("SELECT * FROM t_user e " +
                ...
                "SELECT * FROM t_user e " +
                        "LEFT JOIN t_role e1 ON e1.id = e.id AND e1.org_id = 1 " +
                        "WHERE (e.id = ? OR e.name = ?) AND e.org_id = 1 AND e.dept_id IN (10, 20)");
    ...
    public void testSelectRightJoin() {
        ...
        assertSql("SELECT * FROM t_user e " +
                        ...
                        "WHERE e.id = ? OR e.name = ?",
                "SELECT * FROM t_user e " +
                        "RIGHT JOIN t_role e1 ON e1.id = e.id AND e.org_id = 1 AND e.dept_id IN (10, 20) " +
                        "WHERE (e.id = ? OR e.name = ?) AND e1.org_id = 1");
    ...
    public void testSelectInnerJoin() {
        ...
        assertSql("SELECT * FROM t_user e " +
                        ...
                        "WHERE e.id = ? OR e.name = ?",
                "SELECT * FROM t_user e " +
                        "INNER JOIN entity1 e1 ON e1.id = e.id AND e.org_id = 1 AND e.dept_id IN (10, 20) AND e1.org_id = 1 " +
                        "WHERE e.id = ? OR e.name = ?");
